      ...
      return (
        <Container maxW="container.md" centerContent py={20}>
          <VStack spacing={6} align="stretch">
            ...
            <VStack spacing={4}>
              <Button colorScheme="blue" size="lg" onClick={this.handleReload} width="full">
                רענן את הדף
              </Button>
              <Button variant="outline" size="lg" onClick={this.handleGoHome} width="full">
                חזור לדף הבית
              </Button>
            </VStack>

            {isDevelopment && this.state.error && (
              <Box mt={8} p={4} bg="red.50" borderRadius="md" border="1px" borderColor="red.200">
