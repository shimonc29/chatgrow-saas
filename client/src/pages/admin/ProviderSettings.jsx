...
const ProviderSettings = () => {
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black flex items-center justify-center">
        <div className="text-yellow-400 text-2xl">⏳ טוען הגדרות...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-gray-900 to-black p-8 rtl">
      {/* Header */}
      <div className="max-w-6xl mx-auto">
        ...
        {/* Tabs */}
        <div className="flex gap-4 mb-6 border-b border-yellow-600/30">
          {[
        ...
        {/* Email Settings */}
        {activeTab === 'email' && (
          <div className="bg-black/40 border border-yellow-600/30 rounded-lg p-6 shadow-lg shadow-yellow-500/10">
            <h2 className="text-2xl font-bold text-yellow-400 mb-4">📧 הגדרות אימייל</h2>
            
            <div className="mb-6">
              <label className="block text-gray-300 mb-2">סוג ספק</label>
              <select
                ...
                className="w-full bg-black border border-yellow-600/50 text-gray-200 px-4 py-3 rounded focus:outline-none focus:ring-2 focus:ring-yellow-500"
              >
            ...
            {settings.emailProvider.type === 'sendgrid' && (
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-300 mb-2">SendGrid API Key</label>
                  <input
                    type="password"
                ...
                <div>
                  <label className="block text-gray-300 mb-2">כתובת אימייל שולח</label>
                  <input
                    type="email"
                ...
                <div>
                  <label className="block text-gray-300 mb-2">שם שולח</label>
                  <input
                    type="text"
            ...
            <div className="mt-6 pt-6 border-t border-yellow-600/30">
              <h3 className="text-lg font-semibold text-yellow-400 mb-3">בדיקת תצורה</h3>
              <div className="flex gap-3">
                <input
                  ...
                  className="flex-1 bg-black border border-yellow-600/50 text-gray-200 px-4 py-3 rounded focus:outline-none focus:ring-2 focus:ring-yellow-500"
                />
                <button
                  onClick={handleTestEmail}
                  className="bg-gradient-to-r from-yellow-600 to-yellow-500 text-black px-6 py-3 rounded font-semibold hover:shadow-lg hover:shadow-yellow-500/50 transition-all"
                >
                  שלח בדיקה
                </button>
              </div>
        ...
        {activeTab === 'sms' && (
          <div className="bg-black/40 border border-yellow-600/30 rounded-lg p-6 shadow-lg shadow-yellow-500/10">
            <h2 className="text-2xl font-bold text-yellow-400 mb-4">📱 הגדרות SMS</h2>
            ...
            {settings.smsProvider.type === 'twilio' && (
              <div className="space-y-4">
                <div>
                  <label className="block text-gray-300 mb-2">Account SID</label>
                  <input
                    type="password"
                ...
                <div>
                  <label className="block text-gray-300 mb-2">Auth Token</label>
                  <input
                    type="password"
                ...
                <div>
                  <label className="block text-gray-300 mb-2">מספר טלפון Twilio</label>
                  <input
                    type="tel"
        ...
        {activeTab === 'payment' && (
          <div className="bg-black/40 border border-yellow-600/30 rounded-lg p-6 shadow-lg shadow-yellow-500/10 space-y-6">
            <h2 className="text-2xl font-bold text-yellow-400 mb-4">💳 הגדרות תשלום</h2>
            
            {/* Cardcom */}
            <div className="border border-yellow-600/20 rounded-lg p-4">
              ...
              {settings.paymentGateways.cardcom.enabled && (
                <div className="space-y-4">
                  <div>
                    <label className="block text-gray-300 mb-2">Terminal Number</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-gray-300 mb-2">API Username</label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="block text-gray-300 mb-2">API Password</label>
                    <input
                      type="password"
            ...
            <div className="border border-yellow-600/20 rounded-lg p-4">
              ...
              {settings.paymentGateways.grow.enabled && (
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="block text-gray-300 mb-2">Page Code</label>
                    <input
                      type="text"
        ...
        {activeTab === 'invoice' && (
          <div className="bg-black/40 border border-yellow-600/30 rounded-lg p-6 shadow-lg shadow-yellow-500/10">
            <h2 className="text-2xl font-bold text-yellow-400 mb-4">🧾 הגדרות חשבוניות</h2>
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-gray-300 mb-2">ח.פ / ע.מ</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-gray-300 mb-2">מספר עוסק מורשה</label>
                <input
                  type="text"
              ...
              <div>
                <label className="block text-gray-300 mb-2">רחוב</label>
                <input
                  type="text"
        ...
        <div className="mt-8 flex justify-end">
          <button
            onClick={handleSave}
            disabled={saving}
            className="bg-gradient-to-r from-yellow-600 to-yellow-500 text-black px-8 py-4 rounded-lg font-bold text-lg hover:shadow-xl hover:shadow-yellow-500/50 transition-all disabled:opacity-50"
          >
