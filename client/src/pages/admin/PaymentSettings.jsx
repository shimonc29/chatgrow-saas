  ...
  return (
    <MainLayout>
      <div className="p-8 bg-app-navy min-h-screen">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-accent-copper">הגדרות שירותי תשלום</h1>
          <p className="text-text-light mt-2">הגדר את חיבורי שערי התשלום שלך</p>
        </div>

        {success && (
          <div className="bg-app-navy border border-accent-copper/50 text-accent-copper px-4 py-3 rounded-lg mb-6 shadow-lg shadow-accent-copper/20">
            {success}
          </div>
        )}
        ...
        <div className="space-y-6">
          {/* Meshulam (GROW) */}
          <div className="bg-app-navy border border-accent-copper/30 rounded-xl shadow-lg p-6 hover:border-accent-copper/50 hover:shadow-accent-copper/20 transition-all">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-reverse space-x-3">
                <div className="w-12 h-12 bg-gradient-to-r from-action-blue to-accent-copper rounded-lg flex items-center justify-center">
                  <span className="text-black text-2xl">🌱</span>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-accent-copper">GROW by Meshulam</h3>
                  <p className="text-sm text-text-subtle">שער תשלום ישראלי מוביל</p>
                </div>
              </div>
            ...
            {settings.meshulam.enabled && (
              <div className="space-y-4 mt-6">
                <div>
                  <label className="block text-accent-copper font-medium mb-2">
                    Page Code (מזהה עסק)
                  </label>
                  <input
                    type="text"
                    ...
                    className="w-full px-4 py-2 bg-app-navy border border-accent-copper/30 text-white rounded-lg focus:ring-2 focus:ring-accent-copper focus:border-transparent placeholder-gray-500"
                  />
                </div>
                <div>
                  <label className="block text-accent-copper font-medium mb-2">
                ...
                <div className="bg-black/50 border border-accent-copper/30 text-text-light px-4 py-3 rounded-lg text-sm">
                  💡 <strong className="text-accent-copper">איפה למצוא?</strong> היכנס לחשבון Meshulam שלך → הגדרות → API Credentials
                  <br />
                  📚 <a href="https://grow-il.readme.io/" target="_blank" rel="noopener noreferrer" className="text-accent-copper underline font-semibold hover:text-accent-copper/80">מדריך אינטגרציה מלא</a>
                </div>
              </div>
            )}
          </div>
          ...
          <div className="bg-app-navy border border-accent-copper/30 rounded-xl shadow-lg p-6 hover:border-accent-copper/50 hover:shadow-accent-copper/20 transition-all">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-reverse space-x-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-accent-copper">Cardcom</h3>
                  <p className="text-sm text-text-subtle">שער תשלום לכרטיסי אשראי</p>
                </div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
          ...
          <div className="bg-app-navy border border-accent-copper/30 rounded-xl shadow-lg p-6 hover:border-accent-copper/50 hover:shadow-accent-copper/20 transition-all">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-reverse space-x-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-accent-copper">Tranzila</h3>
                  <p className="text-sm text-text-subtle">פתרון תשלומים מהיר</p>
                </div>
              </div>
              <label className="relative inline-flex items-center cursor-pointer">
                <input
        ...
        <div className="mt-8 flex justify-end">
          <button
            onClick={handleSave}
            disabled={loading}
            className="bg-gradient-to-r from-action-blue to-accent-copper text-white px-8 py-3 rounded-lg font-semibold disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-action-blue/50 hover:shadow-action-blue/70"
          >
        ...
        <div className="mt-8 bg-app-navy border border-accent-copper/30 rounded-xl p-6">
          <h3 className="text-lg font-bold text-accent-copper mb-4">📖 איך להשיג פרטי API?</h3>
          <div className="space-y-3 text-sm text-text-light">
            <div className="flex items-start space-x-reverse space-x-2">
              <span className="font-bold text-accent-copper">🌱 GROW (Meshulam):</span>
              <span>פנה למחלקת התמיכה של Meshulam או היכנס לפאנל הניהול שלך → הגדרות → API</span>
            </div>
            <div className="flex items-start space-x-reverse space-x-2">
              <span className="font-bold text-accent-copper">💳 Cardcom:</span>
              <span>צור קשר עם נציג Cardcom לקבלת פרטי API או גש לאזור האישי</span>
            </div>
            <div className="flex items-start space-x-reverse space-x-2">
              <span className="font-bold text-accent-copper">⚡ Tranzila:</span>
