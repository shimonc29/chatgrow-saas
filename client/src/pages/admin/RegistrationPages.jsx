      ...
      <MainLayout>
        <div className="p-8 flex justify-center items-center min-h-screen">
          <div className="text-center">
            ...
            <p className="text-gray-600">טוען דפי הרשמה...</p>
          </div>
        </div>
      </MainLayout>
    );
  ...
  return (
    <MainLayout>
      <div className="p-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-800">דפי הרשמה</h1>
          <p className="text-gray-600 mt-2">כל קישורי ההרשמה לאירועים ותורים במקום אחד</p>
        </div>
        ...
        <div className="mb-8">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">🗓️ דף הזמנת תורים</h2>
          <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl shadow-md p-6 border-2 border-green-200">
            <div className="flex items-start justify-between">
              <div className="flex-1">
                <h3 className="text-lg font-bold text-gray-800 mb-2">דף הזמנת תורים כללי</h3>
            ...
            <div className="flex space-x-reverse space-x-3 mt-4">
              <button
                ...
                className="flex-1 bg-green-600 hover:bg-green-700 text-white py-3 rounded-lg font-semibold transition-colors flex items-center justify-center space-x-reverse space-x-2"
              >
                <span>{copiedId === 'appointments' ? '✓ הועתק!' : '📋 העתק קישור'}</span>
              </button>
              <button
                onClick={() => openLink('appointments', 'appointments')}
                className="flex-1 bg-white hover:bg-gray-50 text-green-600 border-2 border-green-600 py-3 rounded-lg font-semibold transition-colors flex items-center justify-center space-x-reverse space-x-2"
              >
                <span>🔗 פתח דף</span>
              </button>
            </div>
        ...
        <div>
          <h2 className="text-xl font-semibold text-gray-800 mb-4">🎉 דפי הרשמה לאירועים</h2>
          ...
          {events.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {events.map((event) => (
                <div 
                  key={event._id} 
                  className="bg-gradient-to-br from-purple-50 to-pink-50 rounded-xl shadow-md p-6 border-2 border-purple-200 hover:shadow-lg transition-shadow"
                >
                  <div className="mb-4">
                  ...
                  <div className="bg-white rounded-lg p-3 border border-gray-200 font-mono text-xs text-gray-700 break-all mb-4">
                  ...
                  <div className="flex space-x-reverse space-x-2">
                    ...
                    <button
                      ...
                      className="flex-1 bg-white hover:bg-gray-50 text-purple-600 border-2 border-purple-600 py-2 rounded-lg font-medium transition-colors text-sm"
                    >
                      🔗 פתח
                    </button>
                  </div>
            ...
            <div className="bg-white rounded-xl shadow-md p-12 text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">אין אירועים פעילים</h3>
              <p className="text-gray-600 mb-6">צור אירוע חדש כדי לקבל דף הרשמה</p>
              <button
        ...
        <div className="mt-8 bg-blue-50 border-2 border-blue-200 rounded-xl p-6">
          <div className="flex items-start space-x-reverse space-x-3">
            ...
            <div>
              <h3 className="font-bold text-gray-800 mb-2">איך להשתמש בדפי ההרשמה?</h3>
